      ...
      <div className='px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8'>
        ...
        {showOrderConfirmation && orderDetails && (
          <div className='fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm transition-all duration-300'>
            <div className='bg-white rounded-2xl p-6 w-full max-w-sm mx-6 shadow-2xl transform transition-all scale-100 animate-fade-in-up border border-gray-100'>
              <div className='flex flex-col items-center text-center'>
                ...
                <p className='text-sm text-gray-500 mb-2 max-w-[85%] leading-relaxed'>
                  Thank you for your purchase. We have received your order and will begin processing it right away.
                </p>
                <div className='flex items-center gap-2 mb-5 px-3 py-1.5 bg-green-50 text-green-700 rounded-full text-[10px] font-medium border border-green-100'>
                  <Shield className='w-3 h-3' />
                  <span>Confirmation email sent to your inbox.</span>
                </div>

                <div className='w-full bg-gray-50 rounded-xl p-5 mb-6 border border-gray-100'>
                  <h3 className='text-[10px] uppercase tracking-wider font-bold text-gray-400 mb-3 border-b border-gray-200 pb-1.5 text-left'>Order Summary</h3>
                  <div className='space-y-3'>
                    <div className='flex justify-between items-center group'>
                      <span className='text-xs text-gray-500 group-hover:text-gray-700 transition-colors'>Order ID</span>
                      <span className='font-mono text-xs font-semibold text-gray-900 bg-white px-1.5 py-0.5 rounded border border-gray-200'>#{orderDetails.id}</span>
                    </div>

                    <div className='flex justify-between items-center'>
                      <span className='text-xs text-gray-500'>Amount Paid</span>
                      <div className='text-right'>
                        <span className='font-bold text-gray-900 text-lg block leading-none'>
                          {formatPrice(orderDetails.totalAmount || cartSummary.totalAmount)}
                        </span>
                        <span className='text-[9px] text-gray-400 italic block mt-0.5'>
                          Incl. {formatPrice(orderDetails.gstAmount || cartSummary.gstAmount)} GST
                        </span>
                      </div>
                    </div>
                    ...
                    <div className='flex justify-between items-center'>
                      ...
                      <span className='font-semibold text-blue-700 text-[10px] px-1.5 py-0.5 bg-blue-50 rounded-md border border-blue-100'>
                        {paymentMethod}
                      </span>
                    </div>
                    ...
                    <div className='border-t border-gray-200 mt-1 pt-2'>
                      <div className='flex justify-between items-start text-left'>
                        <span className='text-xs text-gray-500'>Shipping to</span>
                        <div className='text-right max-w-[60%]'>
                          ...
                          <p className='text-[10px] text-gray-500 mt-0.5'>
                            {sameAsBilling ? billingAddress.pincode : selectedShippingAddress.pincode}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className='flex w-full gap-3'>
                  <button
                    ...
                    className='flex-1 px-4 py-3 text-xs font-bold text-gray-600 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 hover:text-gray-900 transition-all duration-200'
                  >
                    CONTINUE SHOPPING
                  </button>
                  <button
                    onClick={handleViewOrder}
                    className='flex-1 px-4 py-3 text-xs font-bold text-white bg-[#ff4747] rounded-xl hover:bg-[#e63e3e] hover:shadow-lg hover:shadow-red-500/20 transition-all duration-200 transform hover:-translate-y-0.5'
                  >
                    VIEW ORDER
                  </button>
                </div>

              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 sm:px-4 py-2 sm:py-3 bg-white border rounded-lg text-[14px] sm:text-base text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-1 transition-all ${errors.name
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-3 sm:px-4 py-2 sm:py-3 bg-white border rounded-lg text-[14px] sm:text-base text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-1 transition-all ${errors.email
                        ? "border-red-500 focus:ring-red-500"
                        : "border-gray-300 focus:ring-red-500 focus:border-red-500"
                        }`}
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-3 sm:px-4 py-2 sm:py-3 bg-white border rounded-lg text-[14px] sm:text-base text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-1 transition-all ${errors.phoneNumber
                        ? "border-red-500 focus:ring-red-500"
                        : "border-gray-300 focus:ring-red-500 focus:border-red-500"
                        }`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-3 sm:px-4 py-2 sm:py-3 bg-white border rounded-lg text-[14px] sm:text-base text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-1 transition-all ${errors.location
                        ? "border-red-500 focus:ring-red-500"
                        : "border-gray-300 focus:ring-red-500 focus:border-red-500"
                        }`}
                    />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    className={`w-full px-3 sm:px-4 py-2 sm:py-3 bg-white border rounded-lg text-[14px] sm:text-base text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-1 transition-all resize-none ${errors.message
                      ? "border-red-500 focus:ring-red-500"
                      : "border-gray-300 focus:ring-red-500 focus:border-red-500"
                      }`}
                  ></textarea>
                ...
                <div>
                  <button
                    type="submit"
                    disabled={loading}
                    className={`w-full px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-medium text-sm sm:text-base transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 ${loading
            ...
            <div className="space-y-6 sm:space-y-8 mt-8 lg:mt-0">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <p className="text-gray-900 font-medium text-sm sm:text-base md:text-base leading-relaxed">
